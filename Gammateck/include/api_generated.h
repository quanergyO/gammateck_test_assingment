...
inline const Figure *GetFigure(const void *buf) {
  return ::flatbuffers::GetRoot<Figure>(buf);
}

inline const Figure *GetSizePrefixedFigure(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<Figure>(buf);
}

inline bool VerifyFigureBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<Figure>(nullptr);
}

inline bool VerifySizePrefixedFigureBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<Figure>(nullptr);
}

inline void FinishFigureBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Figure> root) {
  fbb.Finish(root);
}

inline void FinishSizePrefixedFigureBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Figure> root) {
